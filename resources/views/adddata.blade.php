        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('storedata') }}">
                        {{ csrf_field() }}
						...
						<div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="tgl_lahir" type="text" class="form-control" name="tgl_lahir" required autofocus>
                            </div>
                        </div>
						...
						<div class="form group">
							...
							<div class="col-md-6">
								...
								@foreach ($add as $adds)
									<option value="{{$adds->id}}">{{$adds->nama}}</option>
								@endforeach
								</select>
							</div>
						</div>
